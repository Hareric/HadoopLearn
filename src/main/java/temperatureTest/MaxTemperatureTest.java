...
public class MaxTemperatureTest {
    ...
    public void testMapper() throws IOException {
        ...
        for(Pair pair : expectedOutputList){
            System.out.println("Mapper test:" + pair.getFirst() + " --- " + pair.getSecond()); // 2016 --- 340
        }
    }
    @Test
    public void testReducer() throws IOException {
        ...
        for(Pair pair : expectedOutputList){
            System.out.println("Reducer test" + pair.getFirst() + " --- " + pair.getSecond());
        }
    }
    @Test
    public void testMapperAndReducer() throws IOException {
        ...
        for(Pair pair : expectedOutputList){
            System.out.println("MapReducer test" + pair.getFirst() + " --- " + pair.getSecond()); // 2014 --- 12
        }
    }
}
